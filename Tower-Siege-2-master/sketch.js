...
function draw() {
  ...
  box3.display("blue", "pink");
  box4.display("green", "pink");
  box5.display("indigo", "pink");
  box6.display("purple", "pink");
  box7.display("saffron", "pink");
  box8.display("brown", "pink");
  box9.display("mehroon", "pink");
